...
!(function (e, t) {
  ...
  var l = "4.0.0-pre 40c3abd0ab049449acab5f2e12c34b9cc3199482",
    c = /HTML$/i,
    te = function (e, t) {
  ...
  (te.fn = te.prototype =
      ...
      text: function (e) {
        ...
        if (i) {
          if (1 === i || 9 === i || 11 === i) {
            ...
            for (e = e.firstChild; e; e = e.nextSibling) n += te.text(e);
          } else if (3 === i || 4 === i) return e.nodeValue;
        } else while ((t = e[r++])) n += te.text(t);
        return n;
      },
    ...
    "function" == typeof Symbol &&
      (te.fn[Symbol.iterator] = t[Symbol.iterator]),
    te.each(
  ...
  p && d.push(":enabled", ":disabled"),
    ...
    b.querySelectorAll("[name='']").length ||
      d.push("\\[" + ie + "*name" + ie + "*=" + ie + "*(?:''|\"\")");
  var oe = (d = d.length && new RegExp(d.join("|")));
  try {
    C.querySelectorAll(":scope"), (ee.scope = !0);
  } catch (e) {}
    ...
    return (
      ...
      (n =
        (e.ownerDocument || e) == (t.ownerDocument || t)
          ...
          : 1)
        ? e == C || (e.ownerDocument == C && te.contains(C, e))
          ? -1
          : t == C || (t.ownerDocument == C && te.contains(C, t))
          ? 1
          : 0
        : 4 & n
        ? -1
  ...
  !(function () {
    var e,
      ...
      a =
        ...
        ")*)|.*)\\)|)",
      u = new RegExp(ie + "+", "g"),
      h = new RegExp("^" + ie + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ie + "+$", "g"),
      f = new RegExp("^" + ie + "*," + ie + "*"),
      g = new RegExp("^" + ie + "*([>+~]|" + ie + ")" + ie + "*"),
      v = new RegExp(ie + "|>"),
      l = new RegExp(a),
      p = new RegExp("^" + t + "$"),
      y = {
      ...
      if (!r && (F(e), (e = e || w), T)) {
        ...
        if (!(d[t + " "] || (oe && oe.test(t)))) {
          if (((c = t), (f = e), 1 === p && (v.test(t) || g.test(t)))) {
            ((f = (S.test(t) && I(e.parentNode)) || e) === e && ee.scope) ||
              ((s = e.getAttribute("id"))
                ? (s = te.escapeSelector(s))
    ...
    ((x = te.expr =
      {
                  ...
                  if (l) {
                    if (v) {
                      while (u) {
                        o = e;
                        while ((o = o[u]))
                          if (m ? ne(o, c) : 1 === o.nodeType) return !1;
        ...
        pseudos: {
          ...
          checked: function (e) {
            return (
              (ne(e, "input") && !!e.checked) ||
              (ne(e, "option") && !!e.selected)
            );
          },
          selected: function (e) {
            return (
        ...
        (a = s(
          ...
          (r = function (e, t, n, r, i) {
            ...
            if (((u += l), y && l !== u)) {
              ...
              if (e) {
                if (0 < u) while (l--) c[l] || f[l] || (f[l] = re.call(r));
                f = V(f);
              }
              K.apply(r, f),
  ...
  (te.filter = function (e, t, n) {
    ...
    te.fn.extend({
      ...
      is: function (e) {
        return !!O(
          this,
          "string" == typeof e && q.test(e) ? te(e) : e || [],
          !1
        ).length;
      },
    });
    ...
    if (((n = n || L), "string" == typeof e)) {
      ...
      if (r[1]) {
        if (
          ...
          te.merge(
            this,
            te.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : C, !0)
          ),
      ...
      function (r, i) {
        te.fn[r] = function (e, t) {
          ...
          return (
            ...
            1 < this.length &&
              (R[r] || te.uniqueSort(n), P.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
                ...
                return function () {
                      ...
                      : function () {
                          try {
                            ...
                            te.Deferred.exceptionHook &&
                              te.Deferred.exceptionHook(e, t.stackTrace),
                              u <= i + 1 &&
                                (a !== I && ((n = void 0), (r = [e])),
                                o.rejectWith(n, r));
                          }
                  ...
                  i
                    ...
                    : (te.Deferred.getStackHook &&
                        (t.stackTrace = te.Deferred.getStackHook()),
                      J.setTimeout(t));
                };
              }
              return te
                .Deferred(function (e) {
                  o[0][3].add(
                    l(0, e, "function" == typeof r ? r : $, e.notifyWith)
                  ),
    ...
    te.fn.extend({
      data: function (n, e) {
        ...
        if (void 0 === n) {
          if (
            this.length &&
            ((i = le.get(o)), 1 === o.nodeType && !ue.get(o, "hasDataAttrs"))
          ) {
            t = a.length;
            while (t--)
              a[t] &&
                0 === (r = a[t].name).indexOf("data-") &&
                ((r = Y(r.slice(5))), pe(o, r, i[r]));
      ...
      queue: function (e, t, n) {
        ...
        if (e)
          return (
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = ue.access(e, t, te.makeArray(n)))
                : r.push(n)),
            r || []
          );
      },
  ...
  function ve(e, t) {
    return (
      ...
      ("" === e.style.display && "none" === te.css(e, "display"))
    );
  }
  var ye = /^[a-z]/,
    me =
  ...
  function be(e, t, n, r) {
    var i,
      ...
      u = s(),
      l = (n && n[3]) || (xe(t) ? "px" : ""),
      c = e.nodeType && (!xe(t) || ("px" !== l && +u)) && he.exec(te.css(e, t));
    if (c && c[3] !== l) {
      (u /= 2), (l = l || c[3]), (c = +u || 1);
      while (a--)
        te.style(e, t, c + l),
            ...
            "" === r.style.display &&
              ...
              (l[c] =
                ...
                (u = Ce[s]) ||
                  ...
                  "none" === u && (u = "block"),
                  (Ce[s] = u)))))
          : "none" !== n && ((l[c] = "none"), ue.set(r, "display", n)));
  ...
  x.getRootNode &&
    (ke = function (e) {
      return (
        te.contains(e.ownerDocument, e) || e.getRootNode(Ee) === e.ownerDocument
      );
    });
  var Se = ke,
    Ae = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i,
  ...
  function He(e, t, n, r, i) {
    for (
      ...
      if ((o = e[d]) || 0 === o)
        if ("object" === m(o)) te.merge(p, o.nodeType ? [o] : o);
        else if (Le.test(o)) {
          ...
          te.merge(p, a.childNodes), ((a = f.firstChild).textContent = "");
        } else p.push(t.createTextNode(o));
    (f.textContent = ""), (d = 0);
    while ((o = p[d++]))
      if (r && -1 < te.inArray(o, r)) i && i.push(o);
      else if (
        ((l = Se(o)), (a = Ne(f.appendChild(o), "script")), l && Oe(a), n)
      ) {
        c = 0;
  ...
  (te.event = {
    ...
    dispatch: function (e) {
      var t,
        ...
        c = te.event.special[u.type] || {};
      for (s[0] = u, t = 1; t < arguments.length; t++) s[t] = arguments[t];
      if (
        ((u.delegateTarget = this),
        !c.preDispatch || !1 !== c.preDispatch.call(this, u))
      ) {
        (a = te.event.handlers.call(this, u, l)), (t = 0);
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Pe.test(t.type) && t.click && ne(t, "input") && Be(t, "click", $e),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            Pe.test(t.type) && t.click && ne(t, "input") && Be(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function ze(e, t) {
    return (
      (ne(e, "table") &&
        ne(11 !== t.nodeType ? t : t.firstChild, "tr") &&
    ...
    if (1 === t.nodeType) {
      if (ue.hasData(e) && (s = ue.get(e).events))
        for (i in (ue.remove(t, "handle events"), s))
          for (n = 0, r = s[i].length; n < r; n++) te.event.add(t, i, s[i][n]);
      le.hasData(e) &&
        ((o = le.access(e)), (a = te.extend({}, o)), le.set(t, a));
    }
  }
  function Qe(n, r, i, o) {
    r = h(r);
    ...
    if ("function" == typeof d)
      return n.each(function (e) {
        var t = n.eq(e);
        (r[0] = d.call(this, e, t.html())), Qe(t, r, i, o);
      });
    if (
      f &&
      ((t = (e = He(r, n[0].ownerDocument, !1, n, o)).firstChild),
      ...
      for (s = (a = te.map(Ne(e, "script"), Ve)).length; c < f; c++)
        (u = e),
          c !== p &&
            ((u = te.clone(u, !0, !0)), s && te.merge(a, Ne(u, "script"))),
          i.call(n[c], u, c);
      if (s)
        for (
          l = a[a.length - 1].ownerDocument, te.map(a, Ye), c = 0;
          c < s;
          c++
        )
          (u = a[c]),
            De.test(u.type || "") &&
              ...
              (u.src && "module" !== (u.type || "").toLowerCase()
                ...
                : y(u.textContent.replace(Xe, ""), u, l));
    }
    return n;
  }
  function Je(e, t, n) {
    for (var r, i = t ? te.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || te.cleanData(Ne(r)),
        r.parentNode &&
          (n && Se(r) && Oe(Ne(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  te.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        0 < (a = Ne(s, "script")).length && Oe(a, !u && Ne(e, "script")), s
      );
    },
    ...
    te.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (te.cleanData(Ne(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
          ...
          function (e) {
            ...
            if (
              ...
              try {
                for (; n < r; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (te.cleanData(Ne(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return Qe(
          ...
          function (e) {
            ...
            te.inArray(this, n) < 0 &&
              (te.cleanData(Ne(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
  ...
  function ft(e, t, n, r, i, o) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (u += te.css(e, n + ge[a], !0, i)),
        r
          ? ("content" === n && (u -= te.css(e, "padding" + ge[a], !0, i)),
            "margin" !== n &&
              (u -= te.css(e, "border" + ge[a] + "Width", !0, i)))
          : ((u += te.css(e, "padding" + ge[a], !0, i)),
            "padding" !== n
              ? (u += te.css(e, "border" + ge[a] + "Width", !0, i))
              : (s += te.css(e, "border" + ge[a] + "Width", !0, i)));
    return (
      !r &&
        0 <= o &&
        (u +=
  ...
  function pt(e, t, n) {
    ...
    return (
      ((p && i) ||
        (!ee.reliableTrDimensions() && ne(e, "tr")) ||
        "auto" === a) &&
        e.getClientRects().length &&
        ((i = "border-box" === te.css(e, "boxSizing", !1, r)),
        (o = s in e) && (a = e[s])),
      (a = parseFloat(a) || 0) +
        ft(e, t, n || (i ? "border" : "content"), o, r, a) +
        "px"
    );
  }
  ...
  te.extend({
    ...
    te.each(["height", "width"], function (e, s) {
      te.cssHooks[s] = {
        get: function (e, t, n) {
          if (t)
            return !at.test(te.css(e, "display")) ||
        ...
        set: function (e, t, n) {
          var r,
            i = et(e),
            o = n && "border-box" === te.css(e, "boxSizing", !1, i),
            a = n ? ft(e, s, n, o, i) : 0;
          return (
            a &&
              (r = he.exec(t)) &&
              "px" !== (r[3] || "px") &&
              ((e.style[s] = t), (t = te.css(e, s))),
            ct(0, t, a)
          );
        },
      };
    }),
    te.each({ margin: "", padding: "", border: "Width" }, function (i, o) {
      (te.cssHooks[i + o] = {
        expand: function (e) {
          for (
      ...
      _default: {
        ...
        set: function (e) {
          te.fx.step[e.prop]
            ? te.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!te.cssHooks[e.prop] && null == e.elem.style[ot(e.prop)])
            ? (e.elem[e.prop] = e.now)
  ...
  function mt() {
    gt &&
      (!1 === C.hidden && J.requestAnimationFrame
        ? J.requestAnimationFrame(mt)
        : J.setTimeout(mt, te.fx.interval),
      te.fx.tick());
  }
  function xt() {
    return (
      ...
      if ((n = Tt.prefilters[r].call(l, o, c, l.opts)))
        return (
          "function" == typeof n.stop &&
            (te._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)),
          n
        );
    return (
      te.map(c, wt, l),
      ...
      te.fx.timer(te.extend(u, { elem: o, anim: l, queue: l.opts.queue })),
      l
    );
  }
  (te.Animation = te.extend(Tt, {
    ...
    tweener: function (e, t) {
      "function" == typeof e ? ((t = e), (e = ["*"])) : (e = e.match(W));
          ...
          d))
            u ||
              (v
                ...
                : (v = ue.access(e, "fxshow", { display: l })),
              o && (v.hidden = !g),
              g && je([e], !0),
              p.done(function () {
                for (r in (g || je([e]), ue.remove(e, "fxshow"), d))
                  te.style(e, r, d[r]);
              })),
              (u = wt(g ? v[r] : 0, r, p)),
              r in v ||
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : Ct.test(e.nodeName) || (jt.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
      ...
      toggleClass: function (i, t) {
        ...
        return "boolean" == typeof t && a
          ...
          : this.each(function () {
              var e, t, n, r;
              if (a) {
                (t = 0), (n = te(this)), (r = St(i));
                while ((e = r[t++]))
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              } else (void 0 !== i && "boolean" !== o) || ((e = Et(this)) && ue.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === i ? "" : ue.get(this, "__className__") || ""));
            });
      },
      hasClass: function (e) {
        var t,
        ...
        return arguments.length
          ? ((i = "function" == typeof n),
            this.each(function (e) {
              var t;
              1 === this.nodeType &&
                (null == (t = i ? n.call(this, e, te(this).val()) : n)
                  ? (t = "")
                  : "number" == typeof t
                  ? (t += "")
                  : Array.isArray(t) &&
          ...
          : t
          ? (r =
              te.valHooks[t.type] || te.valHooks[t.nodeName.toLowerCase()]) &&
            "get" in r &&
        ...
        select: {
          get: function (e) {
            ...
            for (r = o < 0 ? u : a ? o : 0; r < u; r++)
              if (
                (n = i[r]).selected &&
                !n.disabled &&
                (!n.parentNode.disabled || !ne(n.parentNode, "optgroup"))
              ) {
          ...
          set: function (e, t) {
            var n,
              ...
              a = i.length;
            while (a--)
              ((r = i[a]).selected = -1 < te.inArray(te(r).val(), o)) &&
                (n = !0);
  ...
  te.extend(te.event, {
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          8 !== n.nodeType &&
          !At.test(d + te.event.triggered) &&
          (-1 < d.indexOf(".") && ((d = (h = d.split(".")).shift()), h.sort()),
          (u = d.indexOf(":") < 0 && "on" + d),
          ((e = e[te.expando]
            ? e
            : new te.Event(d, "object" == typeof e && e)).isTrigger = r
            ? 2
            : 3),
          (e.namespace = h.join(".")),
        ...
        while ((o = p[i++]) && !e.isPropagationStopped())
          (f = o),
            ...
            (l =
              (ue.get(o, "events") || Object.create(null))[e.type] &&
              ue.get(o, "handle")) && l.apply(o, t),
            (l = u && o[u]) &&
              l.apply &&
              G(o) &&
    ...
    te.extend({
      ...
      ajax: function (e, t) {
        ...
        var c,
          ...
          v = te.ajaxSetup({}, t),
          y = v.context || v,
          m = v.context && (y.nodeType || y.jquery) ? te(y) : te.event,
          x = te.Deferred(),
        ...
        if (
          (v.data &&
            ...
            (v.data = te.param(v.data, v.traditional)),
          Gt(Ut, v, t, T),
          h)
        )
          return T;
        for (i in ((g = te.event && v.global) &&
          0 == te.active++ &&
        ...
        v.hasContent
          ...
          : ((o = v.url.slice(f.length)),
            ...
            !1 === v.cache &&
              ((f = f.replace(It, "$1")),
              (o = (Ot.test(f) ? "&" : "?") + "_=" + Nt.guid++ + o)),
            (v.url = f + o)),
        v.ifModified &&
          (te.lastModified[f] &&
            T.setRequestHeader("If-Modified-Since", te.lastModified[f]),
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            !i &&
              -1 < te.inArray("script", v.dataTypes) &&
  ...
  te.ajaxSetup({
    ...
    jsonpCallback: function () {
      var e = Kt.pop() || te.expando + "_" + Nt.guid++;
      return (this[e] = !0), e;
    },
  }),
    ...
    te.fn.extend({
      ...
      offsetParent: function () {
        return this.map(function () {
          ...
          while (e && "static" === te.css(e, "position")) e = e.offsetParent;
          return e || x;
        });
      },
    }),
    ...
    te.each({ Height: "height", Width: "width" }, function (a, s) {
      te.each(
  ...
  return (
    (te.noConflict = function (e) {
      return (
        J.$ === te && (J.$ = tn), e && J.jQuery === te && (J.jQuery = en), te
      );
    }),
